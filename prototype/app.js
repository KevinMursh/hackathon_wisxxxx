...
function openClose() {
  ...
  $("#finalFile").value = ""; $("#finalName").textContent = "尚未上傳"; $("#finalPrev").src = "about:blank"; $("#closeSend").disabled = true;
...
$("#closeSend").addEventListener("click", () => {
  if (!finalPick) { alert("請先上傳訴願審議委員會決定書 PDF，才能結案歸檔。"); return; } const c = S.c;
