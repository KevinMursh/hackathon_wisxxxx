...
const Api = {
  ...
  importChat: (caseId, messages) => req(`/cases/${encodeURIComponent(caseId)}/chat/import`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ messages }) }),
