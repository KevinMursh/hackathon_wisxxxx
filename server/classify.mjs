...
export const DOC_TYPES = ["訴願書", "訴願委任書", "答辯書", "答辯書檢送函", "卷證目錄", "裁處書", "裁處書送達證書", "陳述意見通知書", "通知書送達證書", "陳述意見書", "檢舉資料", "稽查紀錄", "調查筆錄", "採證照片", "影像放大標註", "採證影片", "車籍資料", "係數計算表", "簽呈", "檢驗報告", "契約書", "委員會決定書", "閱覽卷宗申請書", "言詞辯論申請書", "言詞陳述申請書", "參加訴願申請書", "其他", "補充理由書", "補正通知函"];
...
/* ---------- 後處理 ---------- */
export const ORDER = ["訴願書", "訴願委任書", "閱覽卷宗申請書", "言詞辯論申請書", "言詞陳述申請書", "參加訴願申請書", "答辯書檢送函", "答辯書", "卷證目錄", "裁處書", "裁處書送達證書", "檢舉資料", "稽查紀錄", "調查筆錄", "採證照片", "影像放大標註", "採證影片", "車籍資料", "陳述意見通知書", "通知書送達證書", "陳述意見書", "係數計算表", "簽呈", "檢驗報告", "契約書", "委員會決定書", "其他",
  /* 新類別一律加在「其他」之後：seq() 用 indexOf 產生檔名序號，插在中間會讓既有序號位移，
     eval/manifest.json 的 suggestedNameMatch 寫死了數字（例如 27-其他）。 */
  "補充理由書", "補正通知函"];
const seq = (t) => String(Math.max(0, ORDER.indexOf(t)) + 1).padStart(2, "0");

/** 性質（主張／紀錄／證物）由 doc_type 查表，不問模型 */
export const NATURE = {
  "訴願書": "主張", "訴願委任書": "主張", "答辯書": "主張", "陳述意見書": "主張", "閱覽卷宗申請書": "主張", "言詞辯論申請書": "主張", "言詞陳述申請書": "主張", "參加訴願申請書": "主張", "檢舉資料": "主張", "補充理由書": "主張",
  "補正通知函": "紀錄",
